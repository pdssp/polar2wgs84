...
class UtilsMonitoring:  # noqa: R0205
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                if input:
                    logger.log(
                        log_level,
                        f"Input in the function '{func.__name__}' with args={args}, kwargs={kwargs}",
                    )
                ...
                if output:
                    logger.log(
                        log_level,
                        f"Output in the function '{func.__name__}' with result={result}",
                    )
    ...
    @staticmethod
    def time_spend(
        func=None, level="DEBUG", threshold_in_ms=1000
